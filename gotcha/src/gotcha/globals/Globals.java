...
public final class Globals {
	...
	public static final String INSERT_USER = "INSERT INTO USERS (USERNAME, PASSWORD, NICKNAME, DESCRIPTION, PHOTO_URL, STATUS, SIGNED_UP, LAST_SEEN) VALUES (?,?,?,?,?,?,?,?)";
	...
	public static final String SELECT_TEN_CHANNEL_MESSAGES = "SELECT * FROM MESSAGES WHERE RECEIVER=? AND SENT_TIME>=? ORDER BY SENT_TIME DESC OFFSET ? ROWS FETCH NEXT 10 ROWS ONLY";
