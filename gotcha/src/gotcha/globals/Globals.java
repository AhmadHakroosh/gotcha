...
public final class Globals {
	...
	public static final String SELECT_TEN_CHANNEL_MESSAGES = "SELECT * FROM MESSAGES WHERE PARENT_ID=0 AND RECEIVER=? ORDER BY LAST_UPDATE DESC OFFSET ? ROWS FETCH NEXT 10 ROWS ONLY";
	...
	public static final String SELECT_TEN_THREAD_MESSAGES = "SELECT * FROM MESSAGES WHERE PARENT_ID=? ORDER BY LAST_UPDATE DESC OFFSET ? ROWS FETCH NEXT 10 ROWS ONLY";
	public static final String SELECT_LAST_THREAD_MESSAGE = "SELECT * FROM MESSAGES WHERE PARENT_ID=? ORDER BY SENT_TIME DESC FETCH NEXT 1 ROWS ONLY";
	...
	public static final String UPDATE_MESSAGE_LAST_UPDATE_TIME = "UPDATE MESSAGES SET LAST_UPDATE=? WHERE ID=?";
