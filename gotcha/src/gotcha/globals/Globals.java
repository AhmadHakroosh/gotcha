...
public final class Globals {
	...
	public static final String SELECT_USER_BY_NAME_OR_NICKNAME = "SELECT * FROM USERS WHERE NAME=? OR NICKNAME=?";
	public static final String SELECT_USER_BY_NAME_AND_PASSWORD = "SELECT * FROM USERS WHERE NAME=? AND PASSWORD=?";
	public static final String INSERT_USER = "INSERT INTO USERS VALUES (?,?,?,?,?)";
	public static final String UPDATE_USER = "UPDATE USERS SET NAME=?, PASSWORD=?, NICKNAME=?, DESCRIPTION=?, PHOTO=? WHERE NAME=?";
